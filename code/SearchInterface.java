 ...
 * @Description: The interface to show the search result.
 * @Author: Group44
 * @Version:
 * 
 */
public class SearchInterface {
	...
	public SearchInterface(ArrayList<String> searchRouteList) {

		this.searchRouteList.addAll(searchRouteList);
	...
	private void initialize() {
		...
		tv = new RouteTableModel(searchRouteList);
